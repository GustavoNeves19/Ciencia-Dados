...
A curva abaixo mostra que a partir de **K = 5**, a redução de inércia passa a ser marginal, indicando um ponto de equilíbrio ideal entre complexidade e desempenho.
